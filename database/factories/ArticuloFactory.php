...
$factory->define(Articulo::class, function (Faker $faker) {
    return [
            'nombre'=> $faker->randomElement($array = array ('Cuarto Pollo','Porcion Media','Wonder','Medio Pollo','Porcion Completa','Super Wonder','Wonder Pop',   'Cocacola','Fanta','Sprite','Acuarius','Mocochinchi',   'Papas Fritas','Arroz')),
